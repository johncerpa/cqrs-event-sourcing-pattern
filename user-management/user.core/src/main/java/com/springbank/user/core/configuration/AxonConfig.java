...
public class AxonConfig {
    ...
    /**
     * In order to avoid multiple processing of the same event in different threads/nodes
     * @param serializer Serialization mechanism
     * @return Component capable of event tracking tokens
     */
    @Bean
