...
public class RegisterUserController {
     ...
     * It provides the options to send and wait for a result synchronously (with a timeout) or asynchronously
     */
    ...
    public ResponseEntity<RegisterUserResponse> registerUser(@Valid @RequestBody RegisterUserCommand command) {
        ...
        try {
            commandGateway.send(command); // Dispatches the command synchronously
